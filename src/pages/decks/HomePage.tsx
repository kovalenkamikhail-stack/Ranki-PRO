  ...
  return (
    <PageScaffold
      header={
        <PageIntro
          eyebrow="Decks"
          title="Deck-first flashcards for calm daily review that stay with you offline."
          description="Create, rename, and manage decks offline. Each deck opens into a local workspace for manual card work and deck-scoped study, while reading tools and statistics stay nearby without replacing the core flow."
          badges={
            <>
      ...
      detail={
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div>
              <h2 className="text-2xl font-semibold tracking-tight">Study pulse</h2>
              <p className="text-sm text-muted-foreground">
